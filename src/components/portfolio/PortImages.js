    ...
    <div className=" absolute w-[70%] md:w-1/2 h-screen right-0 top-0 ">
      <div className=" w-full flex h-full relative">
        <div className=" w-1/2 h-full">
          <ParallaxLayer offset={3.5} speed={size >= 1024 ? 1.1 : 1.5}>
            <img
              src={img1}
              alt="nothing"
          ...
          <ParallaxLayer offset={3.9} speed={size >= 1024 ? 0.9 : 1.3}>
            <img
              src={img2}
              alt="image2"
        ...
        <div className=" w-1/2 h-full absolute left-1/2 top-1/2">
          <ParallaxLayer offset={3.5} speed={size >= 1024 ? 1.2 : 1.5}>
            <img
              src={img3}
              alt="nothing"
              className=" w-[200px] md:w-[250px]"
          ...
          <ParallaxLayer offset={3.8} speed={size >= 1024 ? 1 : 1.3}>
            <img
              src={img4}
              alt="image2"
              className=" w-[180px] md:w-[220px]"
